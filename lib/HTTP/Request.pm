...
#
# $Id: Request.pm,v 1.1.1.1 1995/06/11 23:29:44 aas Exp $
...
and optional content. Note that the LWP library also
uses this HTTP style requests for non-HTTP protocols.
...
Constructs a new C<LWP::Request> object describing a 
request on the object C<$url> using method C<$method>.
...
variables containing respectively the method of
the request, the URL of the object of the request,
...
sub headerAsMIME { my($self) = shift; 
